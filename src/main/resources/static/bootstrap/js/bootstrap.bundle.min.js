/*!
  ...
  */
!function (e, t) {
    'object' == typeof exports && 'undefined' != typeof module ? t(exports, require('jquery'))  : 'function' == typeof define && define.amd ? define(['exports',
        'jquery'], t)  : t((e = e || self).bootstrap = {
    }, e.jQuery)
}(this, function (e, p) {
    'use strict';
    function i(e, t) {
    ...
    p = p && p.hasOwnProperty('default') ? p.default:
        p;
    var n = 'transitionend';
    function o(e) {
        var t = this,
    ...
    var m = {
        ...
        getTransitionDurationFromElement: function (e) {
            ...
            var t = p(e).css('transition-duration'),
                ...
                i = parseFloat(t),
                o = parseFloat(n);
            return i || o ? (t = t.split(',') [0], n = n.split(',') [0], 1000 * (parseFloat(t) + parseFloat(n)))  : 0
        },
        reflow: function (e) {
    ...
    p(document).on(P.CLICK_DATA_API, D, function (e) {
        ...
        p(window).on(P.LOAD_DATA_API, function () {
            for (var e = [
            ].slice.call(document.querySelectorAll(O)), t = 0, n = e.length; t < n; t++) {
                var i = e[t],
                    o = i.querySelector(N);
                o.checked || o.hasAttribute('checked') ? i.classList.add(T)  : i.classList.remove(T)
            }
            for (var r = 0, s = (e = [
            ].slice.call(document.querySelectorAll(A))).length; r < s; r++) {
                var a = e[r];
            ...
            return e.next = function () {
                ...
                e._setActiveIndicatorElement = function (e) {
                    if (this._indicatorsElement) {
                        var t = [
                        ].slice.call(this._indicatorsElement.querySelectorAll(te));
                        p(t).removeClass(z);
    ...
    p(document).on(V.CLICK_DATA_API, ae, he._dataApiClickHandler),
        p(window).on(V.LOAD_DATA_API, function () {
            for (var e = [
            ].slice.call(document.querySelectorAll(le)), t = 0, n = e.length; t < n; t++) {
                var i = p(e[t]);
        ...
        De = function () {
            function a(t, e) {
                this._isTransitioning = !1,
                    ...
                    this._triggerArray = [
                    ].slice.call(document.querySelectorAll('[data-toggle="collapse"][href="#' + t.id + '"],[data-toggle="collapse"][data-target="#' + t.id + '"]'));
                for (var n = [
                ].slice.call(document.querySelectorAll(Se)), i = 0, o = n.length; i < o; i++) {
                    var r = n[i],
                        s = m.getSelectorFromElement(r),
                        a = [
                        ].slice.call(document.querySelectorAll(s)).filter(function (e) {
                            return e === t
                        });
            ...
            return e.toggle = function () {
                ...
                e.show = function () {
                    var e,
                        t,
                        n = this;
                    if (!this._isTransitioning && !p(this._element).hasClass(ve) && (this._parent && 0 === (e = [
                    ].slice.call(this._parent.querySelectorAll(Ce)).filter(function (e) {
    ...
    var Ie = 'undefined' != typeof window && 'undefined' != typeof document && 'undefined' != typeof navigator,
        Ae = function () {
            for (var e = [
                ...
                'Trident',
                'Firefox'
            ], t = 0; t < e.length; t += 1) if (Ie && 0 <= navigator.userAgent.indexOf(e[t])) return 1;
            return 0
        }();
    ...
    function Fe(e) {
        ...
        return i && 'BODY' !== i && 'HTML' !== i ? - 1 !== ['TH',
            'TD',
            'TABLE'].indexOf(n.nodeName) && 'static' === ke(n, 'position') ? Fe(n)  : n : e ? e.ownerDocument.documentElement : document.documentElement
    }
    function Me(e) {
                ...
                flip: {
                    ...
                    fn: function (m, g) {
                        ...
                        return b.forEach(function (e, t) {
                            ...
                            }, m.offsets.popper, ot(m.instance.popper, m.offsets.reference, m.placement)), m = st(m.instance.modifiers, m, 'flip'))
                        }),
                            m
                    },
                    behavior: 'flip',
                ...
                computeStyle: {
                    ...
                    fn: function (e, t) {
                        ...
                        var s = void 0 !== r ? r : t.gpuAcceleration,
                            ...
                            p = void 0,
                            m = void 0;
                        if (m = 'bottom' == u ? 'HTML' === a.nodeName ? - a.clientHeight + h.bottom : - l.height + h.bottom : h.top, p = 'right' == f ? 'HTML' === a.nodeName ? - a.clientWidth + h.right : - l.width + h.right : h.left, s && d) c[d] = 'translate3d(' + p + 'px, ' + m + 'px, 0)',
                            c[u] = 0,
                            c[f] = 0,
    ...
    function Dt(e, t) {
        ...
        !function (e, t) {
            ...
            Object.keys(ze({
            }, Dt.Defaults.modifiers, i.modifiers)).forEach(function (e) {
            ...
            return e.toggle = function () {
                ...
                e._getPlacement = function () {
                    var e = p(this._element.parentNode),
                        t = zt;
                    return e.hasClass(Ht) ? (t = Vt, p(this._menu).hasClass(Mt) && (t = Yt))  : e.hasClass(Rt) ? t = Gt : e.hasClass(Ft) ? t = $t : p(this._menu).hasClass(Mt) && (t = Xt),
                        t
                },
                ...
                c._clearMenus = function (e) {
                    if (!e || 3 !== e.which && ('keyup' !== e.type || 9 === e.which)) for (var t = [
                    ].slice.call(document.querySelectorAll(Ut)), n = 0, i = t.length; n < i; n++) {
                ...
                c._dataApiKeydownHandler = function (e) {
                    if ((/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || p(e.target).closest(qt).length))  : Lt.test(e.which)) && (e.preventDefault(), e.stopPropagation(), !this.disabled && !p(this).hasClass(xt))) {
                        ...
                        if (n || 27 !== e.which) if (n && (!n || 27 !== e.which && 32 !== e.which)) {
                            var i = [
                            ].slice.call(t.querySelectorAll(Qt)).filter(function (e) {
            ...
            return e.toggle = function (e) {
                ...
                e._setScrollbar = function () {
                    ...
                    if (this._isBodyOverflowing) {
                        var e = [
                            ].slice.call(document.querySelectorAll(En)),
                            t = [
                            ].slice.call(document.querySelectorAll(bn));
    ...
    function In(e, r, t) {
        ...
        for (var n = (new window.DOMParser).parseFromString(e, 'text/html'), s = Object.keys(r), a = [
        ].slice.call(n.body.querySelectorAll('*')), i = function (e) {
            var t = a[e],
                n = t.nodeName.toLowerCase();
            if ( - 1 === s.indexOf(t.nodeName.toLowerCase())) return t.parentNode.removeChild(t),
                'continue';
            var i = [
                ].slice.call(t.attributes),
                o = [
                ].concat(r['*'] || [
                ], r[n] || [
                ]);
    ...
    p(window).on(gi.LOAD_DATA_API, function () {
        for (var e = [
        ].slice.call(document.querySelectorAll(yi)), t = e.length; t--; ) {
            var n = p(e[t]);
            ...
            return e.show = function () {
                ...
                e._transitionComplete = function (e, t, n) {
                    ...
                    if (p(e).addClass(ji), 'tab' === e.getAttribute('role') && e.setAttribute('aria-selected', !0), m.reflow(e), e.classList.contains(Ri) && e.classList.add(Fi), e.parentNode && p(e.parentNode).hasClass(xi)) {
                        ...
                        if (o) {
                            var r = [
                            ].slice.call(o.querySelectorAll(Ki));
                            p(r).addClass(ji)
                        }
